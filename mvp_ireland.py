...
# general tidying!
# land value business
# check out no-adapt cost
# the following problem with our logic (or my implementation of it):
# there is no intersection but wall cost still lower
# all related to my earlier problems
#['Conamara'] :(beta = 1.00)
#				 wall cost: too expensive 1504.11595862
